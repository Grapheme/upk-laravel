...
<fieldset>
	<section>
		...
		<label class="input">
			{{ Form::text('seo_url['.$locale.']',NULL,array('pattern'=>"[a-z0-9\/\-_]{3,}")) }}
		</label>
		<div class="note">
	...
	<section>
		...
		<label class="input">
			{{ Form::text('seo_title['.$locale.']',NULL) }}
		</label>
		<div class="note">
	...
	<section>
		...
		<label class="textarea">
			{{ Form::textarea('seo_description['.$locale.']',NULL,array('rows'=>2)) }}
		</label>
	</section>
	<section>
		<label class="label">Keywords</label>
		<label class="textarea">
			{{ Form::textarea('seo_keywords['.$locale.']',NULL,array('rows'=>2)) }}
		</label>
	</section>
	<section>
		<label class="label">H1</label>
		<label class="input">
			{{ Form::text('seo_h1['.$locale.']',NULL) }}
		</label>
	</section>
</fieldset>