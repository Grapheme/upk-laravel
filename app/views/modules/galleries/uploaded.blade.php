<div class="superbox col-sm-12">
	...
	<div style="display:inline-block; width:100px; height:100px; background:url({{$photo->thumb()}}) no-repeat 50% 50%; background-position:cover; overflow:hidden; position:relative;">
