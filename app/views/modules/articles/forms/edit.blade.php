{{ Form::model($articles,array('url'=>slink::createAuthLink('articles/update/'.$articles->id),'class'=>'smart-form','id'=>'articles-form','role'=>'form','method'=>'post')) }}
			...
			<div class="well">
				...
				<fieldset>
					...
					<section>
						...
						<label class="input">
							{{ Form::textarea('preview',NULL,array('class'=>'redactor')) }}
						</label>
					</section>
