{{ Form::open(array('url'=>slink::createAuthLink('catalogs/manufacturers/store'),'role'=>'form','class'=>'smart-form','id'=>'catalog-manufacturer-form','method'=>'post','files' => true)) }}
	<div class="row margin-top-10">
		<section class="col col-6">
			<div class="well">
				<header>Для добавления производителя заполните форму:</header>
				<fieldset>
					<section>
				...
				@if(Allow::valid_access('templates'))
					<section>
						...
						<label class="select">
							...
							@endforeach
							{{ Form::select('template', $temps,'manufacturer', array('class'=>'template-change','autocomplete'=>'off')) }} <i></i>
						</label>
					</section>
				@endif
					<section>
