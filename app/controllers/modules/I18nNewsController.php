...
class I18nNewsController extends BaseController {
	...
	public function getCreate(){
		...
		return View::make('modules.i18n_news.create',array('templates'=>Template::all(), 'languages'=>Language::retArray(), 'locales' => $this->locales));
	}
	...
	public function postStore(){
		...
		if(Request::ajax()):
			if(I18nNewsMeta::validate(Input::all())):
